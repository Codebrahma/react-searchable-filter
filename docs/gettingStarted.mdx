...
The options for the combo-box are passed as array of objects.
...
values property describes the possible values that the filter provides.
description property the description of each filter.
